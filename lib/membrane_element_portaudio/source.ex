...
#     {@native.destroy(native), %{state | native: nil}}
#   end
#
#   @impl true
#   def handle_other(
#         {:membrane_element_portaudio_output_packet, payload},
...
#
#   @impl true
#   def handle_other({:membrane_element_portaudio_output_packet, _payload}, _ctx, state) do
#     {:ok, state}
#   end
# end
